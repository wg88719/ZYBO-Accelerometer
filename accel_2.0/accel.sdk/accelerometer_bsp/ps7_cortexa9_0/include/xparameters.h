...
/* Definitions for peripheral AXIS_DATA */
#define XPAR_AXIS_DATA_BASEADDR 0x41260000
#define XPAR_AXIS_DATA_HIGHADDR 0x4126FFFF
#define XPAR_AXIS_DATA_DEVICE_ID 0
#define XPAR_AXIS_DATA_INTERRUPT_PRESENT 0
#define XPAR_AXIS_DATA_IS_DUAL 0


/* Definitions for peripheral CE */
#define XPAR_CE_BASEADDR 0x41270000
#define XPAR_CE_HIGHADDR 0x4127FFFF
#define XPAR_CE_DEVICE_ID 1
#define XPAR_CE_INTERRUPT_PRESENT 0
#define XPAR_CE_IS_DUAL 0


/* Definitions for peripheral AXIS_SW */
#define XPAR_AXIS_SW_BASEADDR 0x41220000
#define XPAR_AXIS_SW_HIGHADDR 0x4122FFFF
#define XPAR_AXIS_SW_DEVICE_ID 2
#define XPAR_AXIS_SW_INTERRUPT_PRESENT 0
#define XPAR_AXIS_SW_IS_DUAL 0


/* Definitions for peripheral BTN */
#define XPAR_BTN_BASEADDR 0x41230000
#define XPAR_BTN_HIGHADDR 0x4123FFFF
#define XPAR_BTN_DEVICE_ID 3
#define XPAR_BTN_INTERRUPT_PRESENT 0
#define XPAR_BTN_IS_DUAL 0


/* Definitions for peripheral RST */
#define XPAR_RST_BASEADDR 0x41210000
#define XPAR_RST_HIGHADDR 0x4121FFFF
#define XPAR_RST_DEVICE_ID 4
#define XPAR_RST_INTERRUPT_PRESENT 0
#define XPAR_RST_IS_DUAL 0
...
/* Canonical definitions for peripheral AXIS_DATA */
#define XPAR_GPIO_0_BASEADDR 0x41260000
#define XPAR_GPIO_0_HIGHADDR 0x4126FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXIS_DATA_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral CE */
#define XPAR_GPIO_1_BASEADDR 0x41270000
#define XPAR_GPIO_1_HIGHADDR 0x4127FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_CE_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral AXIS_SW */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXIS_SW_DEVICE_ID
...
#define XPAR_GPIO_3_DEVICE_ID XPAR_BTN_DEVICE_ID
#define XPAR_GPIO_3_INTERRUPT_PRESENT 0
#define XPAR_GPIO_3_IS_DUAL 0

/* Canonical definitions for peripheral RST */
#define XPAR_GPIO_4_BASEADDR 0x41210000
#define XPAR_GPIO_4_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_4_DEVICE_ID XPAR_RST_DEVICE_ID
